        ...
        <div class="container ">
            <div class="row pt-3 ">
                ...
                <div class="col-lg-4 col-md-4  col-sm-12 d-flex justify-content-center align-items-center ">
                    ...
                    <button class="btn btn-outline d-none d-md-flex d-lg-flex"><a href="connection_traitement.php">Déposer
                            une
                            annonce</a></button>
        ...
        <div id="menu" class="container">
            <div class="row ml-2 ml-lg-0 ml-md-0">
                ...
                <div
                    ...
                    <a href="qui_somme_nous.php" class=" aPropos py-2">A propos</a>
                    </div>
